...
__webpack_require__(/*! ./backend/layout */ "./resources/js/backend/layout.js");
...
__webpack_require__(/*! ./backend/ckeditor */ "./resources/js/backend/ckeditor.js");
__webpack_require__(/*! ./backend/ace */ "./resources/js/backend/ace.js");

/***/ }),

/***/ "./resources/js/backend/ace.js":
/*!*************************************!*\
  !*** ./resources/js/backend/ace.js ***!
  \*************************************/
/***/ (() => {
...
$(document).ready(function () {
  $('.ck-editor').each(function () {
    ClassicEditor.create(this)["catch"](function (error) {
      console.error(error);
    });
  });
});
