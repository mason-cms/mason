...
return [
    ...
    'attributes' => [
        ...
        'grecaptcha_secret_key' => "Google reCAPTCHA Secret Key",
    ...
    'submissions' => [
        ...
        'attributes' => [
            ...
            'user_ip' => "IP Address",
            'referrer_url' => "Page",
            'grecaptcha_token' => "Google reCAPTCHA Token",
            'grecaptcha_success' => "Google reCAPTCHA Success",
            'grecaptcha_score' => "Google reCAPTCHA Score",
            'created_at' => "Created on",
            'updated_at' => "Updated on",
            'deleted_at' => "Deleted on",
        ],
